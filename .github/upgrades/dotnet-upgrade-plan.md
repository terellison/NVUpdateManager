...
| Microsoft.Extensions.DependencyInjection.Abstractions | 9.0.1           | 10.0.10     | Recommended for .NET 10.0            |
| Microsoft.Extensions.Hosting                          | 9.0.1           | 10.0.10     | Recommended for .NET 10.0            |
| Microsoft.Extensions.Http                             | 9.0.1           | 10.0.10     | Recommended for .NET 10.0            |
| Microsoft.Windows.Compatibility                       | 9.0.1           | 10.0.10     | Recommended for .NET 10.0            |
...
| System.Security.Cryptography.ProtectedData            | 9.0.1           | 10.0.10     | Recommended for .NET 10.0            |
| System.Text.Json                                      | 9.0.1           | 10.0.10     | Recommended for .NET 10.0            |
...
NuGet packages changes:
  - Microsoft.Extensions.DependencyInjection.Abstractions should be updated from `9.0.1` to `10.0.10` (*recommended for .NET 10.0*)
  - Microsoft.Extensions.Http should be updated from `9.0.1` to `10.0.10` (*recommended for .NET 10.0*)
  - Microsoft.Windows.Compatibility should be updated from `9.0.1` to `10.0.10` (*recommended for .NET 10.0*)
...
NuGet packages changes:
  - System.Security.Cryptography.ProtectedData should be updated from `9.0.1` to `10.0.10` (*recommended for .NET 10.0*)
  - System.Text.Json should be updated from `9.0.1` to `10.0.10` (*recommended for .NET 10.0*)
...
NuGet packages changes:
  - Microsoft.Extensions.Hosting should be updated from `9.0.1` to `10.0.10` (*recommended for .NET 10.0*)
